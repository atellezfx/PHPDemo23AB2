...
export let usuariosPrueba: Usuario[] = [
  { password:'12345', email:'jromo@correo.net', nombre:'José', apellidos:'Romo' },
  { password:'12345', email:'atellez@correo.net', nombre:'Alejandro', apellidos:'Téllez' },
  { password:'12345', email:'cgiron@correo.net', nombre:'Carlos', apellidos:'Girón' },
  { password:'12345', email:'snieto@correo.net', nombre:'Susana', apellidos:'Nieto' },
  { password:'12345', email:'jvera@correo.net', nombre:'Jaime', apellidos:'Vera' }
];
